        ...
        <table class="table table-white table-striped">
            ...
            foreach ($dados as $d) {
                if (empty($d['id_presenca'])) {
                    echo '<tr>';
                    echo '<td>' . $d['nome'] . '</td>'; ?>
                    <th><a class="btn btn-secondary" href="formedit.php?matricula=<?php echo $d['matricula'] ?>&id_turma=<?php echo $id_turma ?>&id_disciplinas=<?php echo $id_disciplinas ?>&hr_batida=<?php echo $data ?>
