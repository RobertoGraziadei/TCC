...
AND horario.horario_inicio < NOW() AND horario.horario_fim > NOW() AND horario.dia = '$dia_semana'"; //TROCAR PARA $dia_semana PARA SER REALMENTE O DIA DA SEMANA
...
?>
<?php
$_SESSION['mensagem'] = "Presença registrada do(a) aluno(a) $nome_aluno";
