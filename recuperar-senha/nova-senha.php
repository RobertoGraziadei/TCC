...
<body class="align">
    <div class="grid">
        <h2>Nova senha</h2>
        <form action="salvar-nova-senha.php" method="POST" class="form login">
            ...
            <div id="inputemail" class="form__field">
                ...
                <input autocomplete="username" disabled value="<?php echo $email ?>"
                    id="login__username" type="email" name="email" class="form__input" placeholder="Email" required>
            </div>
        ...
        <!-- <p class="text--center"> <a href="recuperar-senha/form-recuperar-senha.php">Voltar</a> <svg> -->
        <!-- <use xlink:href="#icon-arrow-right"></use> -->
        </svg></p>
